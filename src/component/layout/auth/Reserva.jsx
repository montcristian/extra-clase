...
const Reserva = () => {
  ...
  const reservarEquipo = () => {
    if (terminosAceptados) {
      ...
      Swal.fire({
        title: "¡Error!",
        text: "Por favor, acepta los términos y condiciones antes de reservar.",
        icon: "error"
      });
    }
  }
      ...
      <div className="ReservaContainer">
        <div className="FormContainer">
          ...
          <form className="ReservaForm">
            ...
            <div>
              <input type="checkbox" id="aceptarTerminos" onChange={(e) => setTerminosAceptados(e.target.checked)} />
